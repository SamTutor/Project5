...
var ViewModel = function () {
    ...
    // Creation of the map and the location of the center of the map
    var map;
    var myCenter = new google.maps.LatLng(35.687589, 139.753516);

    // Array that stores the marker locations
